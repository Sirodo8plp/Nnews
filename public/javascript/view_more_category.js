document.querySelector("#expandCategory").addEventListener("click", () => {
    let button = document.querySelector("#expandCategory");
    let category = document.querySelector("#expandCategory").getAttribute("name");
    ...
    document.querySelector("#expandCategory").parentNode.removeChild(button);

    fetch(`/show/more/${article_counter}/${article_counter+5}/${category}`).
